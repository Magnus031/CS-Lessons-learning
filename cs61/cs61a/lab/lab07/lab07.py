...
def num_trees(n):
    ...
    *   *        *       *
    ...
    if n==1 or n==2:
        return 1
    #Catalen Number is in term of n leaves:the total cases is that f(1)*f(n-1)+f(2)*f(n-2)....f(n-1)f(1) the whole cases sumanation
...
def make_advanced_counter_maker():
    ...
    def count():
        ...
        def process(operations):
            nonlocal global_num,local_num
            "*** YOUR CODE HERE ***"
            if operations=='count':
                local_num+=1
                return local_num
            elif operations=='global-count':
                global_num+=1
                return global_num
            elif operations=='reset':
                local_num=0
            elif operations=='global-reset':
                global_num=0
